...
Obverser::Obverser(const Transform& transform, const std::string& name)
...
void Obverser::Update(const GameTimer& gt)
{
...
void Obverser::Move(const GameTimer& gt)
{
...
void Obverser::Pitch(float angle)
{
...
void Obverser::RotateY(float angle)
{
